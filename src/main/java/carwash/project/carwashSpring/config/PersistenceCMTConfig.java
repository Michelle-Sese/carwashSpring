package carwash.project.carwashSpring.config;
...
@ComponentScan("carwash.project.carwashSpring.datastore")
@EnableJpaRepositories(basePackages = "carwash.project.carwashSpring.datastore.dao")
public class PersistenceCMTConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        em.setPackagesToScan("carwash.project.carwashSpring.datastore.model");
